...
df.sex.null <- read.csv("output/venn_diagram/M_more_F_more_shoulder_same_pheno_fdr_0.05.csv")
df.t_ssp_overlap_exclude_sex <- read.csv("output/venn_diagram/overlap_genes_t_treat_subspecies_More_Lore_exclude_sex_fdr_0.05.csv")
# first is just SP --------------------------------------------------------
...
#
#
#pdf("output/heatmaps_2020/allparts_only_all_t_de_genes_fdr_0.05.pdf", width = 12, height = 10)
...
pdf("output/heatmaps_2020/sex_t_venn_genes_fdr_0.05.pdf", width = 12, height = 10)
